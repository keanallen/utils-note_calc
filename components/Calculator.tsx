...
const Calculator: React.FC<CalculatorProps> = ({ id, onClose }) => {
  ...
  return (
    <div className="bg-gray-800 rounded-2xl shadow-2xl p-4 flex flex-col gap-4 relative min-w-[280px]">
       <button onClick={() => onClose(id)} className="absolute top-2 right-2 text-gray-500 hover:text-white p-1 rounded-full transition-colors">
            <CloseIcon />
       </button>
